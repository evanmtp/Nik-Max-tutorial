...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 180.0, 225.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.texture"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 345.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "s drawbang_"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 30.0, 30.0, 195.0, 90.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 555.0, 750.0, 195.0, 30.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 645.0, 390.0, 80.0, 35.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 465.0, 630.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "line 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 555.0, 85.0, 22.0 ],
					"style" : "",
					"text" : "1., 0. 30000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 210.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "dim 1920 1080"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 435.0, 390.0, 80.0, 35.0 ],
					"style" : ""
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 100.0, 294.0, 155.0, 22.0 ],
									"style" : "",
...
,
					"patching_rect" : [ 585.0, 285.0, 36.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 645.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.0, 105.0, 300.0, 175.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.0, 195.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 720.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "color 1 1 1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 885.0, 135.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.0, 885.0, 120.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 765.0, 120.0, 102.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 690.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "fade full-frame video in/out"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "gl_pix_brcosa.module.maxpat",
					"numinlets" : 2,
					"numoutlets" : 2,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 30.0, 555.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 195.0, 690.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 720.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "color 1 1 1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 195.0, 765.0, 120.0, 102.0 ],
					"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 585.0, 75.0, 62.0, 22.0 ],
									"style" : "",
									"text" : "* 1.77777"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "jit.gl.videoplane default @scale 0.333 0.22 @position 1.05 @blend_enable 1 @tex_scale_x 1.19 @tex_offset_x -0.08 @layer 1 @depth_enable 0"
								}
...
,
					"patching_rect" : [ 30.0, 510.0, 119.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "gl_co_xfade.module.maxpat",
					"numinlets" : 2,
					"numoutlets" : 2,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 30.0, 180.0, 150.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 195.0, 465.0, 60.0, 20.0 ],
					"style" : "",
					"text" : "x position"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 390.0, 270.0, 135.0, 49.0 ],
					"style" : "",
					"text" : "jit.world default @erase_color 0 0 0 1 @enable 1 @fps 30"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 30.0, 285.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 270.0, 15.0, 300.0, 140.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 140.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 39.5, 270.0, 15.0, 270.0, 15.0, 549.0, 39.5, 549.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 180.0, 451.0, 89.5, 451.0 ],
					"source" : [ "obj-21", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 109.75, 434.0, 64.5, 434.0 ],
					"source" : [ "obj-21", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 144.5, 498.0, 114.5, 498.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 69.5, 678.0, 204.5, 678.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 279.5, 498.0, 139.5, 498.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 39.5, 750.0, 204.5, 750.0 ],
					"source" : [ "obj-43", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-14::obj-5::obj-41" : [ "live.text[4]", "live.text[4]", 0 ],
			"obj-14::obj-5::obj-37" : [ "live.text[1]", "live.text", 0 ],
			"obj-14::obj-5::obj-89" : [ "live.text[2]", "live.text[2]", 0 ],
			"obj-14::obj-5::obj-36" : [ "live.text", "live.text", 0 ],
			"obj-14::obj-5::obj-49" : [ "live.button", "live.button", 0 ],
			"obj-14::obj-5::obj-39" : [ "live.text[3]", "live.text", 0 ],
			"obj-14::obj-5::obj-53" : [ "live.button[1]", "live.button", 0 ],
			"obj-14::obj-5::obj-91" : [ "live.text[5]", "live.text[2]", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "movie%.module.maxpat",
...
, 			{
				"name" : "easing.maxpat",
				"bootpath" : "~/Github/TML-depo/TML-code/VIDEO/development/g_easingjs-and-expr",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "syphonclient.maxpat",
				"bootpath" : "~/Github/Nik-Max-tutorial/Jun2_2016_Max",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
